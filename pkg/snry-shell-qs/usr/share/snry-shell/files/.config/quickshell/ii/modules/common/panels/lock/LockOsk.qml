...
Rectangle {
	...
	implicitWidth: keyboardLayout.implicitWidth + padding * 2
	implicitHeight: keyboardLayout.implicitHeight + padding * 2
	...
	component LockOskKey: MouseArea {
		id: keyRoot
		required property var modelData
		...
		property bool isShift: (label.toLowerCase() === "shift")
