...
## quickshell (official Arch package)

- Installed from the official Arch `extra` repository as a pre-built binary.
- Version 0.2.1 or later.
- Extra Qt6/KDE dependencies needed by the illogical-impulse Quickshell config are included in `illogical-impulse-basic`.
